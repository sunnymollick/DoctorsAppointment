            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4">
                        ...
                        <img src="{{ asset('ui/website') }}/img/blog/cat-post/cat-post-3.jpg" alt="post">
                    ...
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="{{ asset('ui/website') }}/img/blog/cat-post/cat-post-2.jpg" alt="post">
                            <div class="categories_details">
                                <div class="categories_text">
                                    <a href="blog-details.html">
                                        <h5>Politics</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="categories_post">
                            <img src="{{ asset('ui/website') }}/img/blog/cat-post/cat-post-1.jpg" alt="post">
                            <div class="categories_details">
                                <div class="categories_text">
                                    <a href="blog-details.html">
                                        <h5>Food</h5>
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget author_widget">
                                <img class="author_img rounded-circle" src="{{ asset('ui/website') }}/img/blog/author.png" alt="">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('ui/website') }}/img/blog/popular-post/post1.jpg" alt="post">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('ui/website') }}/img/blog/popular-post/post2.jpg" alt="post">
                                    <div class="media-body">
                                        <a href="blog-details.html">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('ui/website') }}/img/blog/popular-post/post3.jpg" alt="post">
                                    <div class="media-body">
                                        <a href="blog-details.html">
                                ...
                                <div class="media post_item">
                                    <img src="{{ asset('ui/website') }}/img/blog/popular-post/post4.jpg" alt="post">
                                    <div class="media-body">
                                        <a href="blog-details.html">
                            ...
                            <aside class="single_sidebar_widget ads_widget">
                                <a href="#"><img class="img-fluid" src="{{ asset('ui/website') }}/img/blog/add.jpg" alt=""></a>
                                <div class="br"></div>
                            </aside>
