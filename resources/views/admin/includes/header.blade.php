<div class="header-left">
    <a href="index-2.html" class="logo">
        <img src="{{asset('ui/admin/assets/img/logo.png')}}" width="35" height="35" alt=""> <span>Preclinic</span>
    </a>
</div>
                ...
                <ul class="notification-list">
                    <li class="notification-message">
                        <a href="activities.html">
                            <div class="media">
                                <span class="avatar">
                                    <img alt="John Doe" src="{{asset('ui/admin/assets/img/user.jpg')}}" class="img-fluid">
                                </span>
